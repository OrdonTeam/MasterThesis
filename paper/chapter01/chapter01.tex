...
W tym ujęciu zagadnienie to było badane bardzo intensywnie \cite{fast-algorithm}, \cite{efektywna-procedura}, \cite{new-reduction}, \cite{steinbach-posthoff}, \cite{skowron-rauszer}, \cite{slezak}, \cite{novel-method}.
...
\end{equation}
Do najbardziej znanych algorytmów dekompozycji liniowej stosowanej w generatorach adresów należy algorytm s-min \cite{sasao-recent}, \cite{sasao-s-min}.
