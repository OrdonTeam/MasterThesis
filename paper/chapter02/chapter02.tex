...
która zawiera wynik operacji XOR wszystkich par wierszy o~różnych wartościach funkcji (rysunek \ref{fig:discernibility-table}).
...
Najłatwiej zauważyć to na przykładzie argumentów niezbędnych \ref{fig:required-arguments}.
...
gdyż w minimalnym rozwiązaniu i tak muszą znaleść się argumenty $x_1$ i $x_3$.
