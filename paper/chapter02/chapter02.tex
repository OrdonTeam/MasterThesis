...
Takie wiersze nie są istotne z~punktu widzenia znajdowania minimalnego pokrycie kolumnowego,%TODO: CR: opisać dlaczego
...
\begin{algorithm}[H]
    ...
    \KwResult{$R$}
    $MR\gets$ pusta\;
    \For{dla każdej pary wierszy w $F$ o~różnej wartosci}{
