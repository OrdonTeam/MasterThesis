...
%Algorytm redukcji:
%dla każdego wiersza
%dla pozostałych wierszy o różnej decyzji
%XOR
%dopóki nie pusta
%znajdź wiersz o najmniejszej liczbie jedynek
%znajdź kolumnę o największej liczbie jedynek
%dodaj do reduktu
%usuń uwzględnione pokrycia
%dla każdego argumentu w redukcie (a)
%dla każdego wiersza w tablicy porównań
%sprawdź czy redukt bez (a) zawiera jedynkę
%jeżeli nie przejdź do następnego (a)
%jeżeli żaden wiersz nie był pusty usuń (a) z reduktu
