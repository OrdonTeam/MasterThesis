...
Wszystkie funkcje opisane w tym rozdziale ale nie załączone bezpośrednio,
...
może być układ arytmetyki rozproszonej \cite{memory-capacity} filtru f5 [3].
...
Eksperyment opisany w tym rozdziale dotyczy funkcji ,,1 z 10'' (tabela \ref{1of10}) analizowanej w artykule [10].
...
Dekompozycja liniowa tej funkcji obliczana algorytmem 2-Min oraz 3-Min [10] tworzy układ o 14 wejściach.
Liczby wejść do poszczególnych bramek XOR nie są podane.
