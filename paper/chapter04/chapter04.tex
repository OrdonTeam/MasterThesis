...
\begin{figure}[H]
\centering
\includegraphics[width = 13cm]{chapter04/xor.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 13cm]{chapter04/single-decomposition.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 13cm]{chapter04/multiple-decomposition.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 5cm]{chapter04/multiple-levels.png}
...
Z tego powodu schemat z rysunku numer \ref{fig:multiple-levels} można uprościć do postaci przedstawionej na rysunku numer \ref{multiple-entries}.

\begin{figure}[H]
\centering
\includegraphics[width = 5cm]{chapter04/multiple-entries.png}
